...
Ledger_Spec_v16.0/   The current certified specification, one self-contained file.
v16_workpapers/      Working papers of the v16 passes: deferred settlement (10 rounds
                     of candidates and reviews), temporal, entropy.
...
1. The Constitution: `LedgerManifesto/ledger_manifesto_v1_3.pdf`.
2. The specification: `Ledger_Spec_v16.0/ledger/ledger_v16_0.pdf`.
