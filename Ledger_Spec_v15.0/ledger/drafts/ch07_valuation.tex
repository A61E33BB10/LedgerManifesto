...
OT-1 is a one-touch on stock OMEGA, barrier $80.00$ touch-at-or-below, payout
...
amount --- par plus accrued at the declared rate. At receipt the owned cash and
the obligation are equal and opposite in the owned sum, so net owned value is
unchanged, and NAV does not move.
\end{proposition}
