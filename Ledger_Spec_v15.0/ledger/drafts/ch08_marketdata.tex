...
surviving (\S 2, \S 12); an amended or withdrawn corporate-action notice is this same
case --- a superseding datum recorded at its own observation time, never an edit of the
original notice, so the pre-amendment frame and the corrected one both survive. W3 is the
