...
implementation must pass. They are the boundary minima.
...
The boundary rests on one named trust assumption and no other: TA-KIND, that a kind
...
(Chapter~\ref{ch:marketdata}). Everything else that crosses is recorded, framed, and
replayable.
...
minima (B1--B6) are checkable over generated data and corporate actions: confirm that no
...
generated event, and that each of W1--W4 replays bit-identically
