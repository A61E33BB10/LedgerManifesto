...
\emph{second telling}: every concept is first fully explained in plain terms with a
concrete example, and a marked box may then restate it categorically to remove
residual ambiguity --- nothing later depends on any such box, and deleting them all
