...
labels and groupings; it can never alter a quantity. A figure carrying a wrong
...
\item the \emph{pool predicate} --- a declared wallet and move predicate
  ...
  wallets and moves constituting the reinvestment book);
...
exposure under a governing agreement. The counterparty computes the same figure
