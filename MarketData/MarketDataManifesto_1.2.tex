% =====================================================================
%  THE LEDGER FRAMEWORK — Market Data Manifesto, Version 1.2
...
%  Drafting: GATHERAL (data side) with THORP + KLEPPMANN (backtesting
%  co-leads). Rigor-check: FORMALIS. Review: THORP, KLEPPMANN, TALEB.
%  Certification: CONCORDIA.
...
\begin{center}
  ...
  Version 1.2 \quad---\quad amends the certified 1.0, extends 1.1 \quad---\quad July 2026
\end{center}
