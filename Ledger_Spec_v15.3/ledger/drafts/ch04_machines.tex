...
A captured arrival whose event kind is registered routes as above. One whose kind is
undeclared, or whose reference the record cannot resolve, is still recorded --- as a
\textbf{quarantined event}, the record-then-refuse-processing discipline of failure mode
W4 (Chapter~\ref{ch:marketdata}): never routed, never lost.
