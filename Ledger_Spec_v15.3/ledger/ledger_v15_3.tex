...
Ledger Framework Constitution v1.2: the objects the system manipulates and the signed
...
Framework Constitution v1.2 and against nothing else; each chapter opens by naming the
...
The constitution names both answers and delegates their indexing here. C-12.1 (v1.2) fixes
...
(constitution C-4.12, ratified 2026-07-14, awaiting adoption); a kind is registered, on the record, before any
...
one. C-12.1 (v1.2) names both honest answers and delegates their indexing to this
...
\emph{The discharge.} Constitution C-12.1 (v1.2) names both answers --- what the book said
...
\item \textbf{No captured event is lost.} Every arriving external event must be recorded,
  ...
  returned as a bare value (C-4.12, ratified 2026-07-14, awaiting adoption); later processing is idempotent
