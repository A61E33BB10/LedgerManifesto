...
This is a genuine conflict between the specification and Constitution~\S8. It is
parked --- not resolved, and not relabelled --- as entry PARK-4 of the parking
index (Chapter~\ref{ch:scope}). The parked amendment makes \S8 case~2 conditional
on the obligation being valued at fair value, with any day-one difference
recognised as financing basis. Until it is adopted, the unconditional guarantee
stands in the constitution and the off-market case stands against it, in the open.
\end{proposition}
