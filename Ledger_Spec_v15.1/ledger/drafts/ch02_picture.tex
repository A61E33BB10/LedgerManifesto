...
world presents a list of events, $E = [e]$; a map carries it to a list of transactions,
$T = [tx]$; a fold reduces that list to the ledger; and every number the ledger reports
--- a balance, a valuation, a profit and loss, a report --- is a further fold of that
same one list. Four terms recur, each defined in Chapter~\ref{ch:objects} and used here
