...
boundary failure regimes W1--W4 (Chapter~\ref{ch:marketdata}); and the trigger and event
...
coordinate) grain. The distinction has teeth precisely on the cross-agreement history the
finding names: a wallet posts 100 of a unit under agreement $G_1$ and receives 100 of the
