...
replay already carries the as-of answer --- is exactly the single-axis error the finding
below parks.
...
(Chapter~\ref{ch:marketdata}, regime W2). It is parked, with the exact proposed amendment
