...
No data enters the ledger as a bare read. All data crosses as a recorded
...
-- all data crosses as a recorded Observation; there is no bare read.
...
\emph{declared}. VS-1's $252$ fixings read IDX official closes, and FUT-IDX settles the IDX
