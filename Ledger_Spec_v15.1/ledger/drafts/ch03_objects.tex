...
This chapter discharges constitution clauses C-4.1--C-4.11 --- the objects, the immutable log, and the signed coordinate vector C-4.10 and mass-never-value clause C-4.11 as amended in v1.1 (C-4.10 and C-4.11 jointly with Chapter~\ref{ch:collateral}).
