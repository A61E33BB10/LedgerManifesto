...
compensating transactions, not left as posted. Firing~127 is not trusted to have been right
...
asserted. \S 12 names one timestamp where these properties need two axes; the conflict is
parked as entry PARK-2 of the parking index (Chapter~\ref{ch:scope}).
